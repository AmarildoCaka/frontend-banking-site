...
import { useConditionalBankStoreInterface } from './storeInterfaces';

import { transactionFunct, loanUnitFunct, generalLoanDetailsFunct, generalCardListFunct, generalCardHistoryFunct } from './stateFuncts';
...
export const useConditionalBankStore = create<useConditionalBankStoreInterface>((set, get) => {
  ...
  return {
    ...
    cardAvailabilityBtnFunct: () => {
      ...
      const warningPopUpLogic = (outterStateData === 'Enable')? outterFunctData():(outterStateData === 'Disable')? outterFunctData(): outterFunctData();
    ...
    setMoreActionsState: (value) => {

      set(

        {

          moreActionsState: value
    ...
    setLoanFirstStepToTrue: (value) => {
      ...
      set((data) => ({
        ...
        loanProgressBarObj: { ...data.loanProgressBarObj, loanFirstStep: value }
    ...
    setLoanSecondStepToTrue: (value) => {
      ...
      set((data) => ({
        ...
        loanProgressBarObj: { ...data.loanProgressBarObj, loanSecondStep: value }
    ...
    setGeneralLoanProgressBarToFalse: (firstStepValue, secondStepValue) => {
      ...
      set((data) => ({
        ...
        loanProgressBarObj: { ...data.loanProgressBarObj, loanFirstStep: firstStepValue, loanSecondStep: secondStepValue }
    ...
    setGeneralLoanDetailsFunct: (value) => {
      ...
      localStorage.setItem('generalLoanDetailsStorage', JSON.stringify(value));
