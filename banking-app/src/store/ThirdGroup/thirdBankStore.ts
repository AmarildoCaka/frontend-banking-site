...
import { thirdBankStoreInterface } from "../FirstGroup/storeInterfaces";

import { opinionMsgListFunct, starRatingListFunct, ratingMessageTimeFunct, generatedIdFunct, themeFunct } from '../FirstGroup/stateFuncts';

export const useThirdBankStore = create<thirdBankStoreInterface>((set) => {
  return {
    isOpen: false,
