    ...
    if (firstStepFormFieldErrors.monthlyIncome === true) {
      return (
        <p className="text-red-500 font-semibold text-md">
          Empty last name field, please fill this form
        </p>
      );
  ...
  return (
    <>
      ...
      <section className="flex flex-col justify-evenly gap-2">
        <label className="last-name-label block text-md font-semibold">
          Last Name
        </label>

        <div
          className={`loan-last-name-form flex items-center w-full rounded-md overflow-hidden transform transition duration-300 hover:scale-102 border ${mainConditionLogic}`}
        >
          <input
            type="text"
            value={loanLastName}
          ...
          <button
            type="button"
            className="loan-last-name-copy-btn cursor-pointer tarnsaform transition duration-300 hover:scale-110 px-3 py-2"
            onClick={() => {
          ...
          <button
            type="button"
            className="loan-last-name-erase-btn cursor-pointer tarnsaform transition duration-300 hover:scale-110 px-3 py-2"
            onClick={() => {
