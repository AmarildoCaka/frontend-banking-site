        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-800 mb-2">Apply for a loan here</h1>
      
              <p className="text-gray-600">Configure your loan details and get instant estimates</p>
            ...
            <div className="hidden md:flex space-x-4">
              ...
              <div className="text-center p-4 bg-blue-50 rounded-xl">
                ...
                <p className="font-bold text-blue-600">${loanAmount.toLocaleString()}</p>
