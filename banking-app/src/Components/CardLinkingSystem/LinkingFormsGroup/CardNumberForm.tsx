    ...
    <>
      ...
      <div className="flex flex-col justify-center place-items-center gap-1">
        ...
        <section className="w-[700px] p-1">
          ...
          <label className="text-black font-bold">Card Number</label>

        </section>

        <div className="relative w-[700px]">

          <input type="text" value={cardNumber} maxLength={16} className={`w-[700px] border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 placeholder:font-semibold ${(cardNumber.length < 16 || !isValidCardNumber(cardNumber))? "border border-red-500": "border border-indigo-500"} transform transition duration-300 hover:scale-102 p-2`} placeholder="Card Number" onChange={(e) => {
        ...
        <section className="w-[700px]">
          ...
          {(cardNumber.length < 16 ||!isValidCardNumber(cardNumber))? (
            ...
            <>
              ...
              <p className="text-red-500 text-start font-bold pt-1">Please enter a card number</p>
