      ...
      <div className="fixed inset-0 z-100 flex items-center justify-center">
        <div className="relative flex flex-col justify-evenly place-items-center text-center w-[470px] h-[200px] rounded-2xl shadow-2xl overflow-x-auto space-y-4 animate-fadeIn bg-gradient-to-r from-gray-50 to-blue-50 border border-blue-100">
          <section className="flex flex-col gap-2">
            ...
            <p className="text-black font-semibold text-md text-center">
              Do you want to {accountPremissionState} this account?
            </p>
          </section>
          ...
          <section className="flex flex-row justify-evenly place-items-center gap-5">
            <button
              type="button"
              className="text-white font-bold text-center bg-green-500 rounded-lg shadow-xl cursor-pointer transform transition duration-300 hover:scale-105 px-5 py-1"
              onClick={() => {
            ...
            <button
              type="button"
              className="text-white bg-red-500 font-bold text-center rounded-lg shadow-xl cursor-pointer transform transition duration-300 hover:scale-105 px-5 py-1"
              onClick={() => {
                setToFalseAccountBlockingState();
              }}
            >
