    ...
    <>
      ...
      <div className="fixed inset-0 z-100 flex items-center justify-center">
        <div className="relative flex flex-col justify-center place-items-center text-center animate-fadeIn bg-gradient-to-r from-gray-50 to-blue-50 border border-blue-100 w-[660px] h-[430px] space-y-2 rounded-2xl shadow-2xl overflow-x-auto gap-2">
          ...
          <div
            className={`flex flex-col justify-between place-items-center ${depositHistoryUnitState.length === 0 ? "gap-25" : null} p-1`}
          >
              ...
              <>
                <div className="flex flex-col justify-between place-items-center self-center">
                  <p className="text-gray-500 font-semibold text-lg text-center">
                    No deposits in your deposit history
                  </p>

                  <p className="text-gray-500 font-semibold text-lg text-center">
                    All the deposits made will appear here
                  </p>
                </div>
              </>
            ) : depositHistoryUnitState.length > 0 ? (
              <>
                <div className="flex flex-col justify-center place-items-center text-center h-64 overflow-y-auto p-1">
                  {depositHistoryUnitState.map((deposit, index) => (
                    <div
                      key={deposit.id}
                      className="flex flex-row justify-between items-center w-full max-w-4xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 mb-3 p-6"
                    >
                      ...
                      <div className="flex flex-col gap-2">
                        <button
                          ...
                          onClick={() => {
                            ...
                            showPopUpMessage(
                              `Deposit number ${index + 1} copied successfully!`,
                              "success",
                            );
                          }}
                        >
            ...
            <div
              className={`flex flex-row ${depositHistoryUnitState.length > 0 ? "justify-between" : depositHistoryUnitState.length === 0 ? "justify-center" : null} place-items-center text-center w-full mt-3 p-1`}
            >
              <div className="p-1">
