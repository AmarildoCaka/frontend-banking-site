...
const AmountFormComp = () => {
  ...
  const { withdrawAmount, setWithdrawAmount } = useConditionalBankStore();
  ...
  return (
    ...
    <>
      ...
      <div className="space-y-2">
        ...
        <label className="block font-semibold">Enter Amount</label>

        <div className="relative w-full">
        
          <input type="number" className="text-left text-gray-700 font-bold w-full border border-gray-400 rounded-lg cursor-pointer transform transition duration-300 hover:scale-103 pr-16 p-4" placeholder="Enter your amount here" onChange={(e) => {
