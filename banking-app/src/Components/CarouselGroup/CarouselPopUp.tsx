        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="popup-wrapper flex flex-col gap-3 justify-start items-start text-left w-[570px] min-h-[208px] rounded-lg p-5 shadow-md relative">
            ...
            <section className="flex items-center space-x-3 p-1 rounded-lg transition w-full">
              ...
              <span className="popup-text font-medium text-base">{currentService?.feature?.firstFeature || "Feature not available"}</span>
            ...
            <section className="flex items-center space-x-3 p-1 rounded-lg transition w-full">
              ...
              <span className="popup-text font-medium text-base">{currentService?.feature?.secondFeature || "Feature not available"}</span>
            ...
            <section className="flex items-center space-x-3 p-1 rounded-lg transition w-full">
              ...
              <span className="popup-text font-medium text-base">{currentService?.feature?.thirdFeature || "Feature not available"}</span>
            ...
            <div className="mt-1 w-full flex justify-between items-center relative">
              ...
              <button type="button" className="px-5 py-2 text-red-600 bg-red-50 hover:bg-red-100 border-red-200 border font-bold rounded-md cursor-pointer transition transform duration-300 hover:scale-105" onClick={() => {

                setPopUpState(false);

              }}>Close</button>

              <p className="popup-card-count-text font-semibold text-md absolute bottom-0 right-0">{getNextIndex + 1} / 6</p>
