...
const BottomBtnComp = () => {
  ...
  const { opinionMsgDeletionFunct, ratingMsgTimeDeletionFunct } =
    useGeneralMsgPageLogicHook();
  ...
  const generalRatingListDeletionFunct = () => {
    try {
      ...
      showPopUpMessage(
        "Cannot delete opinion messages from the opinion list",
        "error",
      );
