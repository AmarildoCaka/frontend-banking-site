...
const MsgFooterComp: React.FC<msgFooterCompInterafce> = ({ firstNameData, lastNameData, emailData }) => {
  ...
  const copyEmailFunct = () => {
    ...
    try
    {
      ...
      showPopUpMessage(`${firstNameData} ${lastNameData}'s email copied successfully`, 'info');
    ...
    <>
      ...
      <section className="rating-msg-footer-wrapper rounded-b-md px-6 pb-3">
        ...
        <div className="rating-msg-footer-inner-wrapper flex flex-row justify-between place-items-center text-center gap-2 text-sm pt-2 border-t">
          ...
          <button type="button" className="rating-msg-footer-copy-btn cursor-pointer transform transition duration-300 hover:scale-110" onClick={() => {
