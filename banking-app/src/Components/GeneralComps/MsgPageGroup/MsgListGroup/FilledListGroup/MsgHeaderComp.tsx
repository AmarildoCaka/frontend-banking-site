...
const MsgHeaderComp: React.FC<msgHeaderCompInterface> = ({
  indexData,
  idData,
  firstNameData,
  lastNameData,
  ...
  const deleteSingleListElement = (id: number) => {
    ...
    if (index !== -1) {
      ...
      showPopUpMessage(
        `Opinion number #${index + 1} deleted successfully`,
        "success",
      );
    }
  };
      ...
      <div className="rating-msg-header-wrapper flex items-center justify-between px-6 py-3 border-b">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h3 className="rating-msg-info text-lg font-semibold text-gray-900">
        ...
        <div className="flex items-center gap-x-3">
          <button
            type="button"
            className="rating-msg-copy-btn cursor-pointer transform transition duration-300 hover:scale-110"
            onClick={() => {
              copyOpinionMsgFunct();
            }}
          >
          ...
          <button
            type="button"
            className="rating-msg-delete-btn font-bold cursor-pointer transform transition duration-300 hover:scale-105"
            onClick={() => {
