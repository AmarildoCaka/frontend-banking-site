...
const GeneralAccountSettingsComp = () => {
  ...
  return (
    ...
    <>
      ...
      <div className="account-setting-wrapper rounded-2xl shadow-lg p-6 flex flex-col hover:scale-[1.02] transition-transform duration-300">

        <h3 className="account-setting-text font-semibold text-lg mb-4 flex items-center gap-2">
        ...
        <div>
          ...
          <div className="flex justify-between items-center py-2">
            ...
            <button type="button" className={`px-3 py-1.5 rounded-lg text-sm font-semibold transition transform hover:scale-105 cursor-pointer ${(generalAccountState === "Enabled")? "text-white bg-indigo-600 hover:bg-indigo-700": "bg-gray-300 text-black"}`} onClick={() => {
        ...
        <div>
          ...
          <div className="flex justify-between items-center py-2">
            ...
            <div className="relative bg-gray-200 p-[0.5px] rounded-lg flex gap-2 w-[200px]">
              ...
              {[{
                ...
                <>
                  ...
                  <button key={index} type="button" className={`relative z-10 px-3 py-2 rounded-lg text-sm font-semibold transition transform duration-300 cursor-pointer ${(theme === mode)? "text-white": "text-black"}`} onClick={() => {
