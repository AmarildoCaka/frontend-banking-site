...
import { opinionMsgListInterface, starRatingListInterface, rateMsgSubmitTimeListInterface } from '../../../store/functInterfaces';
...
export const useGeneralLogicHook = () => {
  ...
  // const setValidationObj = useThirdBankStore((state) => state.setValidationObj);

  const setErrors = useThirdBankStore((state) => state.setErrors);

  const setSubmitted = useThirdBankStore((state) => state.setSubmitted);

  const setOpinionMsgList = useThirdBankStore((state) => state.setOpinionMsgList);
  ...
  const setStarRatingList = useThirdBankStore((state) => state.setStarRatingList);
  ...
  const setGeneratedIdNum = useThirdBankStore((state) => state.setGeneratedIdNum);
  ...
  return { copyFirstNameFunct, copyLastNameFunct, copyEmailFunct, copyOpinionMsgFunct, emptyFirstNameFunct, emptyLastNameFunct, emptyEmailFunct, emptyOpinionMsgFunct, handleSubmit, firstNameFormValidationFunct, lastNameFormValidationFunct, emailFormValidationFunct, opinionMsgFormValidationFunct };
