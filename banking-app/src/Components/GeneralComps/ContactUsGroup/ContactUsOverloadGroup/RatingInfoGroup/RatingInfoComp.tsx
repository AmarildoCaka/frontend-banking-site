    ...
    <>
      ...
      <section className="fixed inset-0 flex items-center justify-center z-50 p-4">
        ...
        <div className="relative w-full max-w-lg bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 text-sm transform transition-all duration-300 scale-100 opacity-100 overflow-hidden">
          ...
          <button type="button" className="absolute top-2 right-2 cursor-pointer transform transition duration-300 hover:text-red-500 hover:scale-110 p-1 dark:hover:text-gray-300" onClick={() => {
          
            setRatingInfoUnit(false);
          
          }}>
          
            <FaTimes size={18} className="text-gray-600 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-400"/>

          </button>

          <h2 className="text-2xl font-semibold tracking-tight mb-3 text-gray-800 dark:text-gray-100 text-left">How Our Rating System Works</h2>
