...
const ThirdOverlayModal = () => {
  ...
  const { setThirdModalState } = useThirdBankStore();
    ...
    <>
      ...
      <div className='fixed inset-0 flex flex-col justify-center place-items-center text-center bg-white w-[550px] h-[330px] space-y-2 z-50 rounded-2xl shadow-2xl dark:bg-gray-800 dark:text-white left-94 top-40 p-1'>
        ...
        <div className='text-center'>
          ...
          <h3 className="font-bold text-xl text-gray-800 dark:text-white">Customer-Centric</h3>

          <p className="font-semibold text-gray-800 dark:text-white mt-2">

            At the core of our mission is an unwavering commitment to our customers. 
            We believe that every individual deserves financial solutions that are 
            not only reliable but also personalized. That is why we take the time to 
            truly listen — to understand the unique goals, challenges, and needs of 
            each customer.
