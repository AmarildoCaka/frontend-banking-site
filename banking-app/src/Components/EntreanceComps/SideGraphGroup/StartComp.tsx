      ...
      <section className="hero bg-gradient-to-br from-blue-100 to-indigo-200 py-20 px-6">
        <div className="grid justify-center place-items-center text-center sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-grid-cols-2 2xl:grid-cols-2 gap-8 items-center">
          <div className="flex flex-col md:text-left p-15">
            <div className="p-1">
              <h1 className="hero-text text-black text-5xl font-extrabold transform transition duration-300 hover:scale-103 mb-4">
                Seamless & Secure Banking
              </h1>

              <p className="hero-text text-black text-lg max-w-2xl font-bold mx-auto transform transition durtation-300 hover:scale-102 md:mx-0 mb-6 mt-6">
                Experience modern banking with top-tier security, mobile access,
