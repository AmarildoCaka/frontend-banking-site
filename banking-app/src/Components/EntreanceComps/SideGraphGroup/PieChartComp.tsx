...
const PieChartComp = () => {
  ...
  const { userGrowthSwitch, userActivityData, setUserGrowthSwitch } =
    useBankStore();

  function generateUserStats(totalUsers: number): {
    active: number;
    inactive: number;
  } {
    if (totalUsers <= 0) {
  ...
  return (
    <>
      <div className="relative bg-gradient-to-br from-white/95 to-gray-50/90 dark:from-[#0F172A]/90 dark:to-[#1E293B]/85 backdrop-blur-xl p-6 rounded-2xl shadow-2xl w-[500px] border border-indigo-100/50 dark:border-indigo-500/20 transform transition-all duration-300 hover:scale-[1.02] hover:shadow-indigo-500/10 hover:shadow-3xl">
        ...
        <button
          type="button"
          className="absolute top-4 right-4 text-white font-semibold rounded-lg cursor-pointer bg-gradient-to-r from-indigo-500 to-indigo-600 transform transition-all duration-300 hover:scale-105 hover:from-indigo-600 hover:to-indigo-700 hover:shadow-lg hover:shadow-indigo-500/50 px-4 py-2 text-sm z-20"
          onClick={() => {
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-300">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="flex flex-col items-center p-3 bg-gradient-to-br from-indigo-50 to-indigo-100/50 dark:from-slate-800/70 dark:to-slate-700/40 rounded-xl border border-indigo-200/50 dark:border-indigo-500/20 shadow-sm">
              <span className="text-xs text-gray-600 font-semibold dark:text-gray-400 mb-1">
                Total Users
              </span>
            ...
            <div className="flex flex-col items-center p-3 bg-gradient-to-br from-green-50 to-green-100/50 dark:from-slate-800/70 dark:to-slate-700/40 rounded-xl border border-green-200/50 dark:border-green-500/20 shadow-sm">
              ...
              <span className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-green-500 dark:from-green-400 dark:to-green-300">
                {userStats.active}
              </span>
            </div>
            ...
            <div className="flex flex-col items-center p-3 bg-gradient-to-br from-gray-50 to-gray-100/50 dark:from-slate-800/70 dark:to-slate-700/40 rounded-xl border border-gray-200/50 dark:border-gray-500/20 shadow-sm">
              ...
              <span className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-600 to-gray-500 dark:from-gray-400 dark:to-gray-300">
                {userStats.inactive}
              </span>
            </div>
          </div>
